...
const Button2 = ({label}) => {
  return (
    <button className="relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-gray-800 bg-orange-600 rounded-md group">
      ...
      <span className="absolute bottom-0 left-0 h-full -ml-2 [opacity:0.3]">
      ...
      <span className="absolute top-0 right-0 w-12 h-full -mr-3 [opacity:0.3]">
      ...
      <span className="relative text-base font-semibold">{label}</span>
    </button>
  );
}
